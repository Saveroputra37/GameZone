                ...
                <div key={i} className="group">
                  <button
                    ...
                    className={`w-full flex items-center justify-between p-5 md:p-6 rounded-4xl border transition-all duration-300 
                      ${activeIndex === i ? "bg-orange-500 border-orange-400 shadow-lg" : "bg-[#1e2036] border-white/5 hover:border-orange-500/50"}`}
                  >
                    <span
                    ...
                    <motion.div
                      ...
                      className={
                        activeIndex === i ? "text-white" : "text-orange-500"
                      }
                    >
                      <ChevronDown size={24} />
                    </motion.div>
              ...
              >
                {isSubmitted ? (
                  ...
                  <div className="space-y-5">
                    ...
                    ></textarea>
                    <button className="w-full bg-orange-600 hover:bg-orange-700 text-white py-4 rounded-2xl font-black text-xs uppercase tracking-[0.2em] shadow-xl shadow-orange-600/20 flex items-center justify-center gap-3 active:scale-95 transition-all">
